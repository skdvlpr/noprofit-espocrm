        ...
        return [
            'en_US' => [
                ...
                'labels' => [
                    ...
                    'googleCalendarRoutingHintAutoDedicated' => 'Events go to dedicated calendar CRM - {label} (when admin enabled auto-create).',
            ...
            'it_IT' => [
                ...
                'labels' => [
                    ...
                    'googleCalendarRoutingHintAutoDedicated' => 'Gli eventi vanno nel calendario dedicato CRM - {label} (se l\'admin ha abilitato la creazione automatica).',
            ...
            'ru_RU' => [
                ...
                'labels' => [
                    ...
                    'googleCalendarRoutingHintAutoDedicated' => 'События попадут в отдельный календарь CRM - {label} (если админ включил автосоздание).',
