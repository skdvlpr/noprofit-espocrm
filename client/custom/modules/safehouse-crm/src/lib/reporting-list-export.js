define('safehouse-crm:lib/reporting-list-export', [
    'helpers/export',
    ...
    return {
        ...
        exportModalView: 'safehouse-crm:views/export/modals/export',
        ...
        postReportingEmailExport(data) {
            ...
            Espo.Ajax.postRequest('SafehouseCrm/reporting/email-export', data, {
                timeout: 0,
            })
                .then(() => {
