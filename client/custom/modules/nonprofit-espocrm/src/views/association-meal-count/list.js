define('nonprofit-espocrm:views/association-meal-count/list', [
    ...
    const SUMMARY_URL = 'NonprofitEspocrm/reporting/association-meal-count/summary';
    const TOTALS_URL = 'NonprofitEspocrm/reporting/association-meal-count/totals';
