    ...
    const checklistLines = function () {
        if (isItalian()) {
            return [
                ...
                'Sul telefono: lascia il browser come processo in background. Non chiuderlo con lo swipe né dal gestore app — altrimenti le push possono non arrivare.',
        ...
        return [
            ...
            'On a phone: leave the browser running as a background process. Do not swipe it away or force-close it from the app switcher — otherwise push delivery may stop.',
