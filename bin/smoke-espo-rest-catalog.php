...
/** @var \Espo\Repositories\EmailAddress $emailAddressRepository */
$emailAddressRepository = $em->getRepository(\Espo\Entities\EmailAddress::ENTITY_TYPE);
$forbiddenContact = $emailAddressRepository->getEntityByAddress(
    $forbiddenContactEmail,
    Contact::ENTITY_TYPE
);
$ok(
